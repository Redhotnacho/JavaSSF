...
public class SsfAdjuntoDAO {
    ...
    public SsfAdjunto findSP(int id) {
        SsfAdjunto objAdjunto = null;
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("SwingSafePU");
            EntityManager em = emf.createEntityManager();

            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAdjunto.sp_find", SsfAdjunto.class);
    ...
    public List<SsfAdjunto> getAllSP() {
        List<SsfAdjunto> adjuntos = null;
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("SwingSafePU");
            EntityManager em = emf.createEntityManager();

            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAdjunto.sp_getAll", SsfAdjunto.class);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_data", void.class, ParameterMode.REF_CURSOR);
            storedProcedure.execute();
            String o_glosa = (String) storedProcedure.getOutputParameterValue("o_glosa");
            System.out.println("o_glosa : " + o_glosa);
            adjuntos = (List<SsfAdjunto>) storedProcedure.getOutputParameterValue("o_data");
    ...
    public boolean addSP(SsfAdjunto adjunto) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAdjunto.sp_add", SsfAdjunto.class);
            storedProcedure.registerStoredProcedureParameter("p_id_atencionmedica", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("p_adjunto", String.class, ParameterMode.IN);
    ...
    public boolean updateSP(SsfAdjunto adjunto) {
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("SwingSafePU");
            EntityManager em = emf.createEntityManager();
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAdjunto.sp_update", SsfAdjunto.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("p_id_atencionmedica", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("p_adjunto", String.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("p_url", String.class, ParameterMode.IN);
    ...
    public boolean removeSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAdjunto.sp_delete", SsfAdjunto.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
            storedProcedure.execute();
    ...
    public boolean desactivarSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAdjunto.sp_desactivar", SsfAdjunto.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_estado", Short.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
    ...
    public boolean activarSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAdjunto.sp_activar", SsfAdjunto.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_estado", Short.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
