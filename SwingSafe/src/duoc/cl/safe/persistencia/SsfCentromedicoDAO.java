...
public class SsfCentromedicoDAO {
    ...
    public SsfCentromedico findSP(int id) {
        SsfCentromedico objCentromedico = null;
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("SwingSafePU");
            EntityManager em = emf.createEntityManager();

            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCentromedico.sp_find", SsfCentromedico.class);
    ...
    public List<SsfCentromedico> getAllSP() {
        List<SsfCentromedico> centromedicos = null;
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("SwingSafePU");
            EntityManager em = emf.createEntityManager();

            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCentromedico.sp_getAll", SsfCentromedico.class);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_data", void.class, ParameterMode.REF_CURSOR);
            storedProcedure.execute();
            String o_glosa = (String) storedProcedure.getOutputParameterValue("o_glosa");
            System.out.println("o_glosa : " + o_glosa);
            centromedicos = (List<SsfCentromedico>) storedProcedure.getOutputParameterValue("o_data");
    ...
    public boolean addSP(SsfCentromedico centromedico) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCentromedico.sp_add", SsfCentromedico.class);
            ...
            storedProcedure.setParameter("p_nombre", centromedico.getNombre());
            storedProcedure.setParameter("p_direccion", centromedico.getDireccion());
            storedProcedure.execute();
            String o_glosa = (String) storedProcedure.getOutputParameterValue("o_glosa");
            Short o_estado = (Short) storedProcedure.getOutputParameterValue("o_estado");
    ...
    public boolean updateSP(SsfCentromedico centromedico) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCentromedico.sp_update", SsfCentromedico.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("p_nombre", String.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("p_direccion", String.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_estado", Short.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", centromedico.getId());
            storedProcedure.setParameter("p_nombre", centromedico.getNombre());
            storedProcedure.setParameter("p_direccion", centromedico.getDireccion());
            storedProcedure.execute();
            String o_glosa = (String) storedProcedure.getOutputParameterValue("o_glosa");
    ...
    public boolean removeSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCentromedico.sp_delete", SsfCentromedico.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
            storedProcedure.execute();
    ...
    public boolean desactivarSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCentromedico.sp_desactivar", SsfCentromedico.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_estado", Short.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
    ...
    public boolean activarSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCentromedico.sp_activar", SsfCentromedico.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_estado", Short.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
