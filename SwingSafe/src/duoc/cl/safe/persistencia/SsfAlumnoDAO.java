...
public class SsfAlumnoDAO {
    ...
    public SsfAlumno findSP(int id) {
        SsfAlumno objAlumno = null;
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("SwingSafePU");
            EntityManager em = emf.createEntityManager();

            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAlumno.sp_find", SsfAlumno.class);
    ...
    public List<SsfAlumno> getAllSP() {
        List<SsfAlumno> alumnos = null;
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("SwingSafePU");
            EntityManager em = emf.createEntityManager();

            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAlumno.sp_getAll", SsfAlumno.class);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_data", void.class, ParameterMode.REF_CURSOR);
            storedProcedure.execute();
            String o_glosa = (String) storedProcedure.getOutputParameterValue("o_glosa");
            System.out.println("o_glosa : " + o_glosa);
            alumnos = (List<SsfAlumno>) storedProcedure.getOutputParameterValue("o_data");
            alumnos.forEach((r) -> {
                em.refresh(r);
            });
            return alumnos;
    ...
    public boolean addSP(SsfAlumno alumno) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAlumno.sp_add", SsfAlumno.class);
    ...
    public boolean updateSP(SsfAlumno alumno) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAlumno.sp_update", SsfAlumno.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("p_persona", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("p_empresa", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
    ...
    public boolean removeSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAlumno.sp_delete", SsfAlumno.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
            storedProcedure.execute();
    ...
    public boolean desactivarSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAlumno.sp_desactivar", SsfAlumno.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_estado", Short.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
    ...
    public boolean activarSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfAlumno.sp_activar", SsfAlumno.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_estado", Short.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
