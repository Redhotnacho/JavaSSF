...
public class SsfCertificadoDAO {
    ...
    public SsfCertificado findSP(int id) {
        SsfCertificado objCertificado = null;
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("SwingSafePU");
            EntityManager em = emf.createEntityManager();

            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCertificado.sp_find", SsfCertificado.class);
    ...
    public List<SsfCertificado> getAllSP() {
        List<SsfCertificado> certificados = null;
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("SwingSafePU");
            EntityManager em = emf.createEntityManager();

            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCertificado.sp_getAll", SsfCertificado.class);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_data", void.class, ParameterMode.REF_CURSOR);
            storedProcedure.execute();
            String o_glosa = (String) storedProcedure.getOutputParameterValue("o_glosa");
            System.out.println("o_glosa : " + o_glosa);
            certificados = (List<SsfCertificado>) storedProcedure.getOutputParameterValue("o_data");
            ...
            System.out.println("Error: " + ex.getMessage());
            Logger.getLogger(SsfCertificadoDAO.class.getName()).log(Level.ERROR, null, ex);
            log.log(Level.ERROR, "Error al buscar elementos", ex);
            return null;
        }
    }
    ...
    public boolean addSP(SsfCertificado certificado) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCertificado.sp_add", SsfCertificado.class);
            storedProcedure.registerStoredProcedureParameter("p_contenido", String.class, ParameterMode.IN);
            ...
            storedProcedure.setParameter("p_contenido", certificado.getContenido());
            storedProcedure.setParameter("p_capacitacion", certificado.getIdCapacitacion().getId());
            storedProcedure.execute();
            String o_glosa = (String) storedProcedure.getOutputParameterValue("o_glosa");
            Short o_estado = (Short) storedProcedure.getOutputParameterValue("o_estado");
    ...
    public boolean updateSP(SsfCertificado certificado) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCertificado.sp_update", SsfCertificado.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("p_contenido", String.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("p_capacitacion", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_estado", Short.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", certificado.getId());
            storedProcedure.setParameter("p_contenido", certificado.getContenido());
            storedProcedure.setParameter("p_capacitacion", certificado.getIdCapacitacion().getId());
            storedProcedure.execute();
            String o_glosa = (String) storedProcedure.getOutputParameterValue("o_glosa");
    ...
    public boolean removeSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCertificado.sp_delete", SsfCertificado.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
            storedProcedure.execute();
    ...
    public boolean desactivarSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCertificado.sp_desactivar", SsfCertificado.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_estado", Short.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
    ...
    public boolean activarSP(int id) {
        try {
            ...
            StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery("pkg_ssfCertificado.sp_activar", SsfCertificado.class);
            storedProcedure.registerStoredProcedureParameter("p_id", BigDecimal.class, ParameterMode.IN);
            storedProcedure.registerStoredProcedureParameter("o_glosa", String.class, ParameterMode.OUT);
            storedProcedure.registerStoredProcedureParameter("o_estado", Short.class, ParameterMode.OUT);
            storedProcedure.setParameter("p_id", id);
