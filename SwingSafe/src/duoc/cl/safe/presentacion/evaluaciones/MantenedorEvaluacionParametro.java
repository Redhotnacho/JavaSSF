...
public class MantenedorEvaluacionParametro extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addContainerGap()
                                        .addComponent(lError, javax.swing.GroupLayout.PREFERRED_SIZE, 357, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(20, 20, 20))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(lExito, javax.swing.GroupLayout.PREFERRED_SIZE, 359, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lError, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void resizeTabla() { 
        tblEvaluacionParametro.getColumnModel().getColumn(0).setMaxWidth(40);
        tblEvaluacionParametro.getColumnModel().getColumn(1).setMaxWidth(200);
        tblEvaluacionParametro.getColumnModel().getColumn(2).setMaxWidth(200);
        tblEvaluacionParametro.getColumnModel().getColumn(3).setMaxWidth(60);
        tblEvaluacionParametro.getColumnModel().getColumn(4).setMaxWidth(200);
        tblEvaluacionParametro.getColumnModel().getColumn(5).setMaxWidth(110);
        tblEvaluacionParametro.getColumnModel().getColumn(6).setMaxWidth(50);
    }
