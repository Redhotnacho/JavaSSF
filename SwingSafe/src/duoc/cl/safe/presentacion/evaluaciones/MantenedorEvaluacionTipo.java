 ...
 * @author Nacho
 */
public class MantenedorEvaluacionTipo extends javax.swing.JFrame {

    /**
     * Creates new form MantenedorTipo Evaluación
     */
    ...
    private void initComponents() {
        ...
        tfTipoEval = new javax.swing.JTextField();
        jScrollPane1 = new javax.swing.JScrollPane();
        taDescripcion = new javax.swing.JTextArea();
        jScrollPane2 = new javax.swing.JScrollPane();
        tblEvaluacionTipo = new javax.swing.JTable();
        ...
        jLabel1.setText("Tipo Evaluación:");
        ...
        tblEvaluacionTipo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblEvaluacionTipo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblEvaluacionTipoMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tblEvaluacionTipo);
    ...
    private void tblEvaluacionTipoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEvaluacionTipoMouseClicked
        limpiarMsgs();
        tbEstado.setEnabled(true);
        bModificar.setEnabled(true);
        DefaultTableModel model = (DefaultTableModel) tblEvaluacionTipo.getModel();
        if (Integer.parseInt(model.getValueAt(tblEvaluacionTipo.getSelectedRow(), 4).toString()) == 1) {
        ...
        if (model.getValueAt(tblEvaluacionTipo.getSelectedRow(), 1) != null) {
            tfTipoEval.setText(model.getValueAt(tblEvaluacionTipo.getSelectedRow(), 1).toString());
        } else {
            tfTipoEval.setText("");
        }
        if (model.getValueAt(tblEvaluacionTipo.getSelectedRow(), 2) != null) {
            taDescripcion.setText(model.getValueAt(tblEvaluacionTipo.getSelectedRow(), 2).toString());
        } else {
            taDescripcion.setText("");
        }
    }//GEN-LAST:event_tblEvaluacionTipoMouseClicked

    private void bLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bLimpiarActionPerformed
        tbEstado.setEnabled(false);
        bModificar.setEnabled(false);
        limpiarMsgs();
        tblEvaluacionTipo.clearSelection();
        tfTipoEval.setText("");
        taDescripcion.setText("");
    ...
    private void tbEstadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbEstadoActionPerformed
        ...
        if (tblEvaluacionTipo.getSelectedRow() == -1) {
            tbEstado.setEnabled(false);
            ...
            if (!tbEstado.isSelected()) {
                if (etbo.activarSP(id)) {
                    activarEstado();
                    model.setValueAt("1", tblEvaluacionTipo.getSelectedRow(), 4);
                }
            } else {
                if (etbo.desactivarSP(id)) {
                    desactivarEstado();
                    model.setValueAt("0", tblEvaluacionTipo.getSelectedRow(), 4);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantenedorEvaluacionTipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MantenedorEvaluacionTipo().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblEvaluacionTipo;
    private javax.swing.JTextField tfTipoEval;
    ...
    private void resizeTabla() {
        tblEvaluacionTipo.getColumnModel().getColumn(0).setMaxWidth(40);
        tblEvaluacionTipo.getColumnModel().getColumn(1).setMaxWidth(200);
        tblEvaluacionTipo.getColumnModel().getColumn(2).setMaxWidth(400);
        tblEvaluacionTipo.getColumnModel().getColumn(3).setMaxWidth(120);
        tblEvaluacionTipo.getColumnModel().getColumn(4).setMaxWidth(50);
    }
